...
#include <vector>
#include <memory>
#include "GLViewAAAFinalProject.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewAAAFinalProject > glView( Aftr::GLViewAAAFinalProject::New( args ) );
